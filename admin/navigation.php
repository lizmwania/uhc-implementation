    ...
    <div class="container-fluid">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li <?php $page_title=="Admin Index" ? "class='active'" : ""; echo $page_title;?>>
                ...
                <li>
                <a href="<?php echo $home_url; ?>/admin/manage_notification.php">Notifications</a>
                </li>
                <li>
                <a href="<?php echo $home_url; ?>/admin/viewcomments.php">View Comments</a>
                </li>
            </ul>
