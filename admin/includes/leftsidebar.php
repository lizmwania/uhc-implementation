  ...
  <li class="has_sub">
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="read_users.php">Manage Users</a></li>
   ...
   <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-format-list-bulleted"></i> <span> Notifications </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                                  <li><a href="manage_notification.php">Manage Notifications </a></li>
                                    
                                </ul>
                            </li>  
                            
     <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-format-list-bulleted"></i> <span> Questions </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                                  <li><a href="manage-questions.php">Manage Questions </a></li>
                                  <li><a href="manage-unapproved-questions.php">Unapproved Questions</a></li>
                                    <li><a href="manage-answers.php">Manage Answers</a></li>
                                </ul>
                            </li>   
                    ...
                    <div class="help-box">
                        ...
                        <p class=""><span class="text-custom">Email:</span> <br/> elizabethmwania257@gmail.com</p>
                    </div>
