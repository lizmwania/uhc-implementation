...
<div class="navbar navbar-default navbar-static-top" role="navigation">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo $home_url; ?>">UHC IMPLEMENTATION</a>
        </div>
...
if(isset($_SESSION['logged_in']) && $_SESSION['logged_in']==true && $_SESSION['access_level']=='Customer'){
    ...
    <ul class="nav navbar-nav navbar-right">
        ...
        <ul <?php echo $page_title == "Edit Profile" ? "class='active'" : ""; ?>>
            ...
            <li><a href="./uploadpic.php">edit profile</a></li>
  ...
  // if user was not logged in, show the "login" and "register" options
    ...
    <ul class="nav navbar-nav navbar-right">
        <li <?php echo $page_title=="Login" ? "class='active'" : ""; ?>>
            <a href="<?php echo $home_url; ?>/objects/login.php">
                <span class="glyphicon glyphicon-log-in"></span> Log In
            </a>
        </li>
     
        <li <?php echo $page_title=="Register" ? "class='active'" : ""; ?>>
            <a href="<?php echo $home_url; ?>objects/register.php">
